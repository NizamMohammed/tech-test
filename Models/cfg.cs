...
namespace CDRApi.Models
{
	...
	public partial class Aurora {
		...
		public static partial class Config {
			...
			// Product version
			public const string ProductVersion = "17.0.4";

			// Project
			public const string ProjectNamespace = "CDRApi";

			public const string ProjectClassName = "CDRApi.Models.Aurora"; // DN
			...
			public const string ProjectName = "Aurora"; // Project name

			public static string AreaName { get; set; } = ""; // Area name // DN

			public static string ControllerName { get; set; } = "Home"; // Controller name // DN

			public const string ProjectId = "{3E7C111B-849A-452C-AA2C-7EC6E8102DD7}"; // Project ID (GUID)

			public static string RandomKey = "qybQmrC8xGlu4V6D"; // Random key for encryption

			public static string EncryptionKey = ""; // Encryption key for data protection

			public static string ProjectStylesheetFilename = "css/aurora.css"; // Project stylesheet file name (relative to wwwroot)
			...
			public static string SidebarClass = "main-sidebar sidebar-dark-purple";

			public static string NavbarClass = "main-header navbar navbar-expand navbar-purple navbar-dark";
			...
			public static string UploadAllowedFileExtensions = "gif,jpg,jpeg,bmp,png,doc,docx,xls,xlsx,pdf,zip,csv"; // Allowed file extensions
			...
			public static List<string> DownloadAllowedFileExtensions = new List<string> {"csv","pdf","xls","doc","xlsx","docx","txt"}; // Allowed file extensions for download (non-image)

			public static bool EncryptFilePath = true; // Encrypt file path

			public static int MaxFileSize = 2147483647; // Max file size
