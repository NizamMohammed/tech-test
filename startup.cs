	...
	public class Startup
	{
		...
		public void ConfigureServices(IServiceCollection services)
		{
			...
			services.AddSession(options => {
				options.Cookie.Name = ".Aurora.Session";
		...
		public void Configure(IApplicationBuilder app, IWebHostEnvironment env, IAntiforgery antiforgery, IHttpContextAccessor httpContextAccessor,ILoggerFactory loggerFactory)
		{
			loggerFactory.AddFile("Logs/CDRApiLog-{Date}.txt",LogLevel.Error);
			...
			app.UseRouting();
			app.UseCookiePolicy();
			Aurora.Configure(httpContextAccessor, env, Configuration, antiforgery);
